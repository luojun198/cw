    ...
    <el-card>
      <el-form :model="form" label-width="180px">
        ...
        <el-form-item label="使用单位名称">
          <el-input v-model="form.unit_name" style="width: 300px" placeholder="请输入使用单位名称" />
        ...
        <el-form-item label="当前会计区间">
          <span class="readonly-value">{{ meta.current_year }} 年 第 {{ meta.current_period }} 期</span>
        </el-form-item>
        ...
        <el-form-item label="凭证审核">
          ...
          <span class="form-label-tip">{{ form.require_audit ? '需要审核后才能记账' : '可以直接记账' }}</span>
