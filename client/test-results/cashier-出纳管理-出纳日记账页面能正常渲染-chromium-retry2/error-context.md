...
- Name: cashier.spec.ts >> 出纳管理 >> 出纳日记账页面能正常渲染
- Location: e2e\cashier.spec.ts:13:3
...
Locator: locator('h3')
Expected substring: "出纳日记账"
Error: strict mode violation: locator('h3') resolved to 5 elements:
    1) <h3 data-v-7f773d42="">近 6 期收入与支出结构</h3> aka getByRole('heading', { name: '近 6 期收入与支出结构' })
    2) <h3 data-v-7f773d42="">处理提醒</h3> aka getByRole('heading', { name: '处理提醒' })
    3) <h3 data-v-7f773d42="">近期凭证</h3> aka getByRole('heading', { name: '近期凭证' })
    4) <h3 data-v-7f773d42="">现金银行结构</h3> aka getByRole('heading', { name: '现金银行结构' })
    5) <h3 data-v-7f773d42="">本期发生额 Top 5</h3> aka getByRole('heading', { name: '本期发生额 Top' })
